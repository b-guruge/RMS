...
-- ----------------------------
INSERT INTO `grn_details_ey` VALUES ('1', '19', 'PO8856', '1', '0.00', '0.00', '0.00', '100.00', '3', '650.00', '1', '2020-08-31', '12:39:35');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `all_asset_view_columns` AS SELECT * FROM const_asset_view_columns CAVC WHERE CAVC.active_flag = 1 ;

-- ----------------------------
-- View structure for get_all_companies
-- ----------------------------
DROP VIEW IF EXISTS `get_all_companies`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `get_all_companies` AS SELECT CM.id, CM.company_name AS val FROM company_master CM WHERE CM.active_flag = 1 ;

-- ----------------------------
-- View structure for get_all_completed_audits
-- ----------------------------
DROP VIEW IF EXISTS `get_all_completed_audits`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `get_all_completed_audits` AS SELECT
	AH.company,
	AH.id,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `get_all_countries` AS SELECT CM.id, CM.country AS val FROM country_master CM ;

-- ----------------------------
-- View structure for get_all_currency
-- ----------------------------
DROP VIEW IF EXISTS `get_all_currency`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `get_all_currency` AS SELECT
	(CM.id) AS id,
	CM.currency AS val
FROM
	`currency_master` CM
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `get_all_downloadable_software` AS SELECT
	DS.id,
	DS.software,
	DS.download_path,
	DS.version
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `get_all_lines` AS SELECT
LM.id,
LM.line_name,
LM.description,
LM.active_flag
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `get_all_locations` AS SELECT LM.id, LM.location AS val, LM.company FROM `location_master` LM WHERE LM.active_flag = 1 ;

-- ----------------------------
-- View structure for get_all_units
-- ----------------------------
DROP VIEW IF EXISTS `get_all_units`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `get_all_units` AS SELECT
	UM.id,
	UM.uom AS val,
	UM.company
FROM
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `get_all_users` AS SELECT
UL.id AS ID,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `get_all_zones` AS SELECT
	ZM.id,
	ZM.zone_name,
	ZM.description
FROM
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `get_depreciation_methods` AS SELECT
	DM.id,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `get_stored_assets` AS SELECT
	SD.asset_id,
	AM.asset_name,
	ZM.zone_name,
	LM.line_name,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `get_unapproved_users` AS SELECT
UL.id,
UL.user_name,
UL.known_name,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `get_user_levels` AS SELECT
	UL.id,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER  VIEW `get_user_salutations` AS SELECT US.id, US.salutation AS val FROM user_salutation US ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `check_user_access`(IN `UID` int,IN `NAV_PAGE` int, IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_all_products`(IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_all_products_for_location`(IN `COMPANY` int,IN `location` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_audit_counts`(IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_audit_summary_report`(IN `COMPANY` int,IN `audit_id` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_audit_users`(IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_barcode_details`(IN `COMPANY` int,IN `uni_id` int,IN `auto_letter` varchar(10))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_barcode_print_unique_id`(IN `COMPANY` int, IN `AUTO_FLAG` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_bl__nbl_nti_assets`(IN `COMPANY` int, IN `VALUE` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_details_for_asset_and_grn`(IN `COMPANY` int,IN `asset_id` int,IN `grn_id` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_grn_details_for_asset`(IN `COMPANY` int,IN `asset_id` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_grn_unique_id`(IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_last_audit_location_flag`(IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_levelwise_pallets`(IN `zone_id` int,IN `line_id` int,IN `level_id` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_started_audit`(IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_started_audit_location`(IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_store_tag_availability`(IN `tag_id` varchar(255))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_total_asset_count_for_location`(IN `COMPANY` int,IN `loc_id` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_unfinished_audit_locations`(IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_zonewise_assets`(IN `ZONE` int,IN `LINE` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `save_audit_header`(IN `au_name` varchar(200),IN `init_by` varchar(255),IN `st_date` varchar(20),IN `st_time` varchar(10),IN `com` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `save_audit_locations`(IN `au_id` int,IN `loc_id` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `save_audit_users`(IN `au_id` int,IN `uid` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `save_grn_ey`(IN `COMPANY` int, IN `asset_id` int, IN `pono` varchar(200), IN `uomem` int, IN `l_qty` varchar(20), IN `s_qty` varchar(20), IN `d_qty` varchar(20), IN `tot_qty` varchar(20), IN `loc` int, IN `price_in` varchar(20), IN `curr` int, IN `date` varchar(20), IN `time` varchar(10))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `save_grn_sunshine`(IN `COMPANY` int, IN `asset_id` int, IN `bno` varchar(200), IN `exp_date` varchar(20), IN `uomem` varchar(100), IN `car_p_size` varchar(100), IN `car_qty` varchar(20), IN `l_qty` varchar(20), IN `s_qty` varchar(20), IN `d_qty` varchar(20), IN `tot_qty` varchar(20), IN `loc` int, IN `price_in` varchar(20), IN `curr` int, IN `date` varchar(20), IN `time` varchar(10))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `save_print_sunshine`(IN `COMPANY` int,IN `uni_id` int,IN `asset_id` int, IN `grn_id` int,IN `pcode` varchar(200),IN `aflag` int,IN `bno` varchar(200),IN `price_val` varchar(50),IN `st_seq` int,IN `qty` int,IN `pdate` varchar(40),IN `ptime`  varchar(10))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `store_asssets`(IN `tag_id` varchar(255),IN `zone` int,IN `line` int,IN `level` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `test_procedure`(IN `COMPANY` int,IN `BARCODE` varchar(255))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `transfer_assets`(IN `tag_id` varchar(255),IN `zone` int,IN `line` int,IN `level` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_audit_barcode_read`(IN `COMPANY` int,IN `BARCODE` varchar(255), IN `user_id` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_audit_completion`(IN `COMPANY` int, IN `edate` varchar(20), IN `etime` varchar(10))
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_audit_location_end`(IN `COMPANY` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_audit_location_start`(IN `COMPANY` int,IN `location_id` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `user_signin`(IN `UNAME` varchar(100),IN `PASSWORD` varchar(255), IN `COMPANY` INT)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `view_grn`(IN `COMPANY` int)
BEGIN
